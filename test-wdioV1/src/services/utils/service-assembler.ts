...
export function assembleServices(services: IServices): IGetAppServices {
...
interface IServices {
  home: IServiceFactoryArgs;
  cardDeck: IServiceFactoryArgs;
  cardDeckList: IServiceFactoryArgs;
}
